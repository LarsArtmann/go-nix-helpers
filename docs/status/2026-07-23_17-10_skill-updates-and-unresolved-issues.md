...
| --- | --------------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Skill cross-references**                                      | All three skills mention go-standard and link to the repo | Skills don't mention the _full option list_ (enableTempl, deps, subModules, ldflags, etc.) — they'd need to visit the repo README for that              |
