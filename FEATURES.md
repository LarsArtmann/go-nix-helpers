...
| `enableCompletions` option                                                     | 🟢 `FULLY_FUNCTIONAL` | Installs shell completions for the default binary                                             |
...
| Module-level tests (options, types, outputs)                                   | 🟢 `FULLY_FUNCTIONAL` | `test-module.nix` with 40+ assertions wired as flake checks                                   |
...
| Module test suite (`test-module.nix`)                | 🟢 `FULLY_FUNCTIONAL` | 40+ assertions: options, types, defaults, perSystem outputs, overlay    |
